...
/*
 * Returns a function that will resolve node callback with a promise's resolve/reject.
 */
exports.callbackPromiseResolver = function callbackPromiseResolver(resolve, reject) {
    return function resolver(err) {
        if (err) {
            return reject(err);
        }
        else {
