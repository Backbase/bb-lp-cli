...
var webpackConf = utils.deepMerge(baseWebpackConfig,  {
    ...
    module: {
        preLoaders: [{
            ...
            include: [
                utils.resolve(config.paths.target),
                utils.resolve(config.paths.scripts),
                includeEntryInTests,
