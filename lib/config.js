...
exports.paths = utils.extend({
    ...
    routes: {
      ...
      '$(contextRoot)/static/features/%5BBBHOST%5D': 'bower_components',
      '$(contextRoot)/static/features/[BBHOST]': 'bower_components',
      '/features/%5BBBHOST%5D': 'bower_components',
      '/features/[BBHOST]': 'bower_components'
    }
}, config.paths || {});
...
exports.autoprefixer = utils.extend({
    browsers: [
        'last 2 versions',
        'iOS >= 7'
    ]
