...
module.exports = function build(v) {
    ...
    tasks.lint()
        ...
        .then(function() {
            ...
            if (withConfig) {
                infoMessageArray.push('with config...\n');
                buildConfig.excludes && infoMessageArray.push('\x1b[36m Excluded components:\x1b[0m [' + buildConfig.excludes.toString() + ']\n');
                buildConfig.entryPoint && infoMessageArray.push('\x1b[36m Entry point:\x1b[0m ' + buildConfig.entryPoint + '\n');
            } else if (withExcludes) {
                infoMessageArray.push('excluding');
                infoMessageArray.push(excludesArray.toString());
            }
