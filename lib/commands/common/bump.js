...
module.exports = function build(options) {
    ...
    .then(function(bowerJson) {
        ...
        return Promise.all([writeBower(bowerJson), updateReadme(version, options.silent), updateChangelog(version, message, commits)])
        .then(function() {
...
function updateReadme(version, silent) {
    var readme = require('../../tasks/docs/readme')();
