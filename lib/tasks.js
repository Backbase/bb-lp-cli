...
gulp.task('build:scripts', [], function() {
    ...
    var isModuleID = config.withModuleId === true || config.withModuleId === "true" || utils.isUndefined(config.withModuleId) ;

    if (isModuleID) {
        webpackConf.output.id = typeof config.withModuleId === 'string' ? config.withModuleId : config.name;
